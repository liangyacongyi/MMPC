...
# -*- encoding: utf-8 -*-
"""
@File    :   resnet_cifar_train_MMPC_one_phase.py
@Contact :   liangyacongyi@163.com

@Modify Time      @Author    @Version    @Desciption
------------      -------    --------    -----------
2020/5/27 06:10 PM   liangcong      1.0   Train ResNet model on CIFAR-10/100 with unbiased constraint loss (one-phase)

run this file with
"python resnet_cifar_train_MMPC_one_phase.py --data_type=cifar_10 --num_blocks=3
...
tf.app.flags.DEFINE_float("_lambda", 2., "constraints on unbiased constrained loss, default: 2.0")
...
PAR_PATH = "./" + _DATA_TYPE + "/" + str(6 * _NUM_BLOCKS + 2) + "/MMPC/one_phase/version_" \
